...
* what is an arrray? properties of array
  ...
  * size of array needs to be specified mandatorily and can not be modified.
    * one of the biggest limitations of arrray
...
* types of array and how to access to its elements

  * 1차원 배열
    * arr [col]
  * 다차원 배열
    * 2차원 배열: m행 n열
      * represented by two subscriptions
      * arr [row] [col]
    * 3차원: arr [depth] [row] [col]
    * 자바에서는 255차원까지 허용함
